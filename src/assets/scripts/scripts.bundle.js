    ...
    var t = {}
      ...
      , l = function() {
        $('[data-ktportlet="true"]').each(function() {
            var t = $(this);
            !0 !== t.data("data-ktportlet-initialized") && (o(t, {}),
            t.data("data-ktportlet-initialized", !0))
        })
    }
      , r = function() {
    ...
    return {
        ...
        block: function(t, e) {
            ...
            if (e.message && e.message.length > 0) {
                ...
                KTUtil.addClass(n, o),
                n.innerHTML = "<span>" + e.message + "</span><span>" + i + "</span>",
    ...
    return {
        ...
        getHighestZindex: function(t) {
            for (var e, a, n = KTUtil.get(t); n && n !== document; ) {
                if (("absolute" === (e = KTUtil.css(n, "position")) || "relative" === e || "fixed" === e) && (a = parseInt(KTUtil.css(n, "z-index")),
                !isNaN(a) && 0 !== a))
                    return a;
                n = n.parentNode
            }
        ...
        hasFixedPositionedParent: function(t) {
            for (; t && t !== document; ) {
                if (position = KTUtil.css(t, "position"),
                "fixed" === position)
                    return !0;
                t = t.parentNode
            }
        ...
        data: function(t) {
            ...
            {
                set: function(e, a) {
                    void 0 !== t && (void 0 === t.customDataTag && (KTUtilElementDataStoreID++,
                    t.customDataTag = KTUtilElementDataStoreID),
                    void 0 === KTUtilElementDataStore[t.customDataTag] && (KTUtilElementDataStore[t.customDataTag] = {}),
        ...
        outerWidth: function(t, e) {
            if (!0 === e) {
                ...
                return a += parseFloat(KTUtil.css(t, "margin-left")) + parseFloat(KTUtil.css(t, "margin-right")),
                parseFloat(a)
            }
        ...
        off: function(t, e, a) {
            t && KTUtilDelegatedEventHandlers[a] && (KTUtil.removeEvent(t, e, KTUtilDelegatedEventHandlers[a]),
            delete KTUtilDelegatedEventHandlers[a])
        },
        one: function(t, e, a) {
            (t = KTUtil.get(t)).addEventListener(e, function t(e) {
                return e.target && e.target.removeEventListener && e.target.removeEventListener(e.type, t),
                a(e)
            })
        },
        hash: function(t) {
        ...
        scrollInit: function(t, e) {
            function a() {
                var a, n;
                if (n = e.height instanceof Function ? parseInt(e.height.call()) : parseInt(e.height),
                (e.mobileNativeScroll || e.disableForMobile) && KTUtil.isInResponsiveRange("tablet-and-mobile"))
                ...
                else if (n > 0 && KTUtil.css(t, "height", n + "px"),
                e.desktopNativeScroll)
                    KTUtil.css(t, "overflow", "auto");
                else {
                    KTUtil.css(t, "overflow", "hidden"),
                    (a = KTUtil.data(t).get("ps")) ? a.update() : (KTUtil.addClass(t, "kt-scroll"),
        ...
        scrollDestroy: function(t) {
            var e;
            (e = KTUtil.data(t).get("ps")) && (e.destroy(),
            e = KTUtil.data(t).remove("ps"))
        },
        ...
        if (0 !== t(this).length) {
            ...
            var l = {
                ...
                init: function(e) {
                    ...
                    l.spinnerCallback(!0),
                    "remote" !== e.data.type && "local" !== e.data.type || ((!1 === e.data.saveState || !1 === e.data.saveState.cookie && !1 === e.data.saveState.webstorage) && l.stateRemove(l.stateId),
                    ...
                    var e = []
                      , n = t(o).find("tr:first-child th").get().map(function(a, n) {
                        ...
                        for (var r in i.columns)
                            i.columns[r].field === o && (l = t.extend(!0, {}, i.columns[r], l));
                        return e.push(l),
                        o
                    });
                    i.columns = e;
                                ...
                                0 === t(this).find(".kt-datatable__lock").length && t(this).ready(function() {
                                    !function(a) {
                                        if (t(a).find(".kt-datatable__lock").length > 0)
                                            ...
                                            e.lockEnabled.left.length > 0 && (t(o.wrap).addClass("kt-datatable--lock"),
                                            t(n).appendTo(a)),
                                            (e.lockEnabled.left.length > 0 || e.lockEnabled.right.length > 0) && t(i).appendTo(a),
                                            e.lockEnabled.right.length > 0 && (t(o.wrap).addClass("kt-datatable--lock"),
                                            t(r).appendTo(a))
                                        } else
                ...
                adjustLockContainer: function() {
                    ...
                    return t(o.table).find(".kt-datatable__lock--scroll").css("width", i),
                    i
                },
                dragResize: function() {
                    ...
                    t(o.tableHead).find(".kt-datatable__cell").mousedown(function(o) {
                        ...
                        t(i).removeClass("kt-datatable__cell--resizing"),
                        n = !1
                    }),
                ...
                initHeight: function() {
                    if (i.layout.height && i.layout.scroll) {
                        ...
                        t(o.tableBody).find(".kt-datatable__lock--scroll").css("height", n)
                    }
                },
                setupBaseDOM: function() {
                    o.initialDatatable = t(o).clone(),
                    "TABLE" === t(o).prop("tagName") ? (o.table = t(o).removeClass("kt-datatable").addClass("kt-datatable__table"),
                    0 === t(o.table).parents(".kt-datatable").length && (o.table.wrap(t("<div/>").addClass("kt-datatable").addClass("kt-datatable--" + i.layout.theme)),
                    o.wrap = t(o.table).parent())) : (o.wrap = t(o).addClass("kt-datatable").addClass("kt-datatable--" + i.layout.theme),
                    o.table = t("<table/>").addClass("kt-datatable__table").appendTo(o)),
                    void 0 !== i.layout.class && t(o.wrap).addClass(i.layout.class),
                    t(o.table).removeClass("kt-datatable--destroyed").css("display", "block"),
                ...
                setupSystemColumn: function() {
                    ...
                    0 !== o.dataSet.length) {
                            ...
                            t(n).find(".kt-datatable__cell").each(function(a, n) {
                                ...
                                if (void 0 !== i) {
                                    ...
                                    if (void 0 !== i.selector && !1 !== i.selector) {
                                        if (t(n).find('.kt-checkbox [type="checkbox"]').length > 0)
                                            return;
                                    ...
                                    if (void 0 !== i.subtable && i.subtable) {
                                        if (t(n).find(".kt-datatable__toggle-subtable").length > 0)
                                            return;
                        ...
                        i.layout.header && a(t(o.tableHead).find(".kt-datatable__row").first()),
                        i.layout.footer && a(t(o.tableFoot).find(".kt-datatable__row").first())
                    }
                },
                maxWidthList: {},
                adjustCellsWidth: function() {
                    ...
                    if (a > 0) {
                        ...
                        t(o.table).find(".kt-datatable__row").find(".kt-datatable__cell").not(".kt-datatable__toggle-detail").not(":hidden").each(function(e, a) {
                            var i = n
                              , r = t(a).data("width");
                            if (void 0 !== r)
                                if ("auto" === r) {
                    ...
                    var e = {
                        ...
                        init: function() {
                            ...
                            if (i.layout.scroll) {
                                ...
                                t(r).find(".kt-datatable__row").length > 0 && t(r).length > 0 ? (e.scrollHead = t(o.tableHead).find("> .kt-datatable__lock--scroll > .kt-datatable__row"),
                                e.scrollFoot = t(o.tableFoot).find("> .kt-datatable__lock--scroll > .kt-datatable__row"),
                                e.tableLocked = t(o.tableBody).find(".kt-datatable__lock:not(.kt-datatable__lock--scroll)"),
                                l.getOption("layout.customScrollbar") && 10 != a.detectIE() && n > a.getBreakpoint("lg") ? e.initCustomScrollbar(r[0]) : e.initDefaultScrollbar(r)) : t(o.tableBody).find(".kt-datatable__row").length > 0 && (e.scrollHead = t(o.tableHead).find("> .kt-datatable__row"),
                                e.scrollFoot = t(o.tableFoot).find("> .kt-datatable__row"),
                        ...
                        initDefaultScrollbar: function(a) {
                            ...
                            !0 !== l.getOption("rows.autoHide") && t(a).css("overflow-x", "auto")
                        },
                ...
                dataRender: function(e) {
                    ...
                    var a = function() {
                      ...
                      , n = function(e) {
                        var n = function(e, a) {
                            t(e.pager).hasClass("kt-datatable--paging-loaded") || (t(e.pager).remove(),
                            e.init(a)),
                            t(e.pager).off().on("kt-datatable--on-goto-page", function(n) {
                                t(e.pager).remove(),
                                e.init(a)
                            });
                        ...
                        if (t(o.wrap).removeClass("kt-datatable--error"),
                        i.pagination)
                ...
                insertData: function() {
                    ...
                    if (t.each(o.dataSet, function(n, r) {
                        ...
                        for (var p = 0; p < u; p += 1) {
                            var f = i.columns[p]
                              , g = [];
                            if (l.getObject("sort.field", e) === f.field && g.push("kt-datatable__cell--sorted"),
                            void 0 !== f.textAlign) {
                ...
                getData: function() {
                    ...
                    return t.ajax(e).done(function(e, a, n) {
                        ...
                        t(o.tableBody).html(t("<span/>").addClass("kt-datatable--error").html(l.getOption("translate.records.noRecords"))),
                        t(o.wrap).addClass("kt-datatable--error kt-datatable--loaded"),
                        l.spinnerCallback(!1)
                    }).always(function() {})
                },
                paging: function(e, n) {
                    var i = {
                        ...
                        init: function(e) {
                            ...
                            t(i.pager).hasClass("kt-datatable--paging-loaded") || (t(i.pager).remove(),
                        ...
                        populate: function() {
                            ...
                            t("<li/>").append(t("<a/>").attr("title", a.first).addClass("kt-datatable__pager-link kt-datatable__pager-link--first").append(t("<i/>").addClass(e.first)).on("click", i.gotoMorePage).attr("data-page", 1)).appendTo(n),
                            t("<li/>").append(t("<a/>").attr("title", a.prev).addClass("kt-datatable__pager-link kt-datatable__pager-link--prev").append(t("<i/>").addClass(e.prev)).on("click", i.gotoMorePage)).appendTo(n),
                            t("<li/>").append(t("<a/>").attr("title", a.more).addClass("kt-datatable__pager-link kt-datatable__pager-link--more-prev").html(t("<i/>").addClass(e.more)).on("click", i.gotoMorePage)).appendTo(n),
                            t("<li/>").append(t("<input/>").attr("type", "text").addClass("kt-pager-input form-control").attr("title", a.input).on("keyup", function() {
                            ...
                            t("<li/>").append(t("<a/>").attr("title", a.more).addClass("kt-datatable__pager-link kt-datatable__pager-link--more-next").html(t("<i/>").addClass(e.more)).on("click", i.gotoMorePage)).appendTo(n),
                            t("<li/>").append(t("<a/>").attr("title", a.next).addClass("kt-datatable__pager-link kt-datatable__pager-link--next").append(t("<i/>").addClass(e.next)).on("click", i.gotoMorePage)).appendTo(n),
                            t("<li/>").append(t("<a/>").attr("title", a.last).addClass("kt-datatable__pager-link kt-datatable__pager-link--last").append(t("<i/>").addClass(e.last)).on("click", i.gotoMorePage).attr("data-page", i.meta.pages)).appendTo(n),
                            l.getOption("toolbar.items.info") && (i.pagerLayout.info = t("<div/>").addClass("kt-datatable__pager-info").append(t("<span/>").addClass("kt-datatable__pager-detail"))),
                        ...
                        paste: function() {
                            t.each(t.unique(l.getOption("toolbar.placement")), function(e, a) {
                                ...
                                "top" === a && t(i.pager).clone(!0).addClass("kt-datatable__pager--top").insertBefore(o.table)
                            })
                        },
                        ...
                        gotoPage: function(e) {
                            e.preventDefault(),
                            t(this).hasClass("kt-datatable__pager-link--active") || i.openPage(parseInt(t(this).data("page")))
                        },
                        openPage: function(e) {
                        ...
                        updatePerpage: function(e) {
                            e.preventDefault(),
                            i.pager = t(o.table).siblings(".kt-datatable__pager").removeClass("kt-datatable--paging-loaded"),
                            e.originalEvent && (i.meta.perpage = parseInt(t(this).val())),
                            t(i.pager).find("select.kt-datatable__pager-size").val(i.meta.perpage).attr("data-selected", i.meta.perpage),
                        ...
                        addPaginateEvent: function(e) {
                            t(o).off(i.paginateEvent).on(i.paginateEvent, function(e, a) {
                                ...
                                t(n).find('.kt-datatable__pager-link-number[data-page="' + a.page + '"]').addClass("kt-datatable__pager-link--active"),
                                t(n).find(".kt-datatable__pager-link--prev").attr("data-page", Math.max(a.page - 1, 1)),
                                t(n).find(".kt-datatable__pager-link--next").attr("data-page", Math.min(a.page + 1, a.pages)),
                                t(i.pager).each(function() {
                                    t(this).find('.kt-pager-input[type="text"]').prop("value", a.page)
                                }),
                                t(i.pager).find(".kt-datatable__pager-nav").show(),
                                a.pages <= 1 && t(i.pager).find(".kt-datatable__pager-nav").hide(),
                                l.setDataSourceParam("pagination", {
                                    page: i.meta.page,
                                    pages: i.meta.pages,
                                    perpage: i.meta.perpage,
                                ...
                                t(i.pager).find("select.kt-datatable__pager-size").val(a.perpage).attr("data-selected", a.perpage),
                                t(o.table).find('.kt-checkbox > [type="checkbox"]').prop("checked", !1),
                                t(o.table).find(".kt-datatable__row--active").removeClass("kt-datatable__row--active"),
                                i.updateInfo.call(),
                                i.pagingBreakpoint.call()
                            })
                        },
                        ...
                        paginationUpdate: function() {
                            ...
                            1 === i.meta.page ? (t(r).attr("disabled", !0).addClass("kt-datatable__pager-link--disabled"),
                            t(s).attr("disabled", !0).addClass("kt-datatable__pager-link--disabled")) : (t(r).removeAttr("disabled").removeClass("kt-datatable__pager-link--disabled"),
                            t(s).removeAttr("disabled").removeClass("kt-datatable__pager-link--disabled")),
                            i.meta.page === i.meta.pages ? (t(d).attr("disabled", !0).addClass("kt-datatable__pager-link--disabled"),
                            t(c).attr("disabled", !0).addClass("kt-datatable__pager-link--disabled")) : (t(d).removeAttr("disabled").removeClass("kt-datatable__pager-link--disabled"),
                            t(c).removeAttr("disabled").removeClass("kt-datatable__pager-link--disabled"));
                ...
                setupSubDatatable: function() {
                    ...
                    if ("function" == typeof e && !(t(o.table).find(".kt-datatable__subtable").length > 0)) {
                        ...
                        var a = function(a) {
                            ...
                            0 === t(r).length && (r = t("<tr/>").addClass("kt-datatable__row-subtable kt-datatable__row-loading").hide().append(t("<td/>").addClass("kt-datatable__subtable").attr("colspan", l.getTotalColumns())),
                            t(n).after(r),
                            ...
                            t(n).hasClass("kt-datatable__row--subtable-expanded") ? (t(c).addClass(l.getOption("layout.icons.rowDetail.collapse")),
                            t(n).removeClass("kt-datatable__row--subtable-expanded"),
                            t(o).trigger("kt-datatable--on-collapse-subtable", [n])) : (t(c).addClass(l.getOption("layout.icons.rowDetail.expand")),
                            t(n).addClass("kt-datatable__row--subtable-expanded"),
                            t(o).trigger("kt-datatable--on-expand-subtable", [n])),
                            0 === t(s).find(".kt-datatable").length && (t.map(o.dataSet, function(t, e) {
                            ...
                            a.subTable = s,
                            e(a),
                            t(s).children(".kt-datatable").on("kt-datatable--on-init", function(e) {
                            ...
                            t(i).find(".kt-datatable__cell").each(function(e, i) {
                                ...
                                if (void 0 !== o) {
                                    ...
                                    if (void 0 !== o.subtable && o.subtable) {
                                        if (t(i).find(".kt-datatable__toggle-subtable").length > 0)
                                            return;
                    ...
                    setTimeout(function() {
                        ...
                        t(o.tableBody).each(function() {
                            for (var a = 0; t(this)[0].offsetWidth < t(this)[0].scrollWidth && a < i.columns.length; )
                                t(o.table).find(".kt-datatable__row").each(function(a) {
                        ...
                        e && t(o.tableBody).find(".kt-datatable__row").each(function() {
                            0 === t(this).find(".kt-datatable__toggle-detail").length && t(this).prepend(t("<td/>").addClass("kt-datatable__cell kt-datatable__toggle-detail").append(t("<a/>").addClass("kt-datatable__toggle-detail").attr("href", "").on("click", n).append('<i class="' + l.getOption("layout.icons.rowDetail.collapse") + '"></i>'))),
                            0 === t(o.tableHead).find(".kt-datatable__toggle-detail").length ? (t(o.tableHead).find(".kt-datatable__row").first().prepend('<th class="kt-datatable__cell kt-datatable__toggle-detail"><span></span></th>'),
                            t(o.tableFoot).find(".kt-datatable__row").first().prepend('<th class="kt-datatable__cell kt-datatable__toggle-detail"><span></span></th>')) : t(o.tableHead).find(".kt-datatable__toggle-detail").find("span")
                        })
                    }),
                ...
                setAutoColumns: function() {
                    ...
                    l.setHeadTitle(),
                    l.getOption("layout.footer") && (t(o.tableFoot).find(".kt-datatable__row").remove(),
                    l.setHeadTitle(o.tableFoot)))
                },
                isLocked: function() {
                ...
                getDepth: function() {
                    var e = 0
                      , a = o.table;
                    do {
                        a = t(a).parents(".kt-datatable__table"),
                        e++
                    } while (t(a).length > 0);return e
                },
                stateKeep: function(t, e) {
                    t = l.getTablePrefix(t),
                    !1 !== l.getOption("data.saveState") && (l.getOption("data.saveState.webstorage") && localStorage && localStorage.setItem(t, JSON.stringify(e)),
                    l.getOption("data.saveState.cookie") && Cookies.set(t, JSON.stringify(e)))
                },
                ...
                getTotalColumns: function(e) {
                    ...
                    t(e).find(".kt-datatable__row").first().find(".kt-datatable__cell").length
                },
                getOneRow: function(e, a, n) {
                    void 0 === n && (n = !0);
                    var i = t(e).find(".kt-datatable__row:not(.kt-datatable__row-detail):nth-child(" + a + ")");
                    return n && (i = i.find(".kt-datatable__cell")),
                    i
                },
                ...
                sorting: function() {
                    var e = {
                        init: function() {
                            i.sortable && (t(o.tableHead).find(".kt-datatable__cell:not(.kt-datatable__cell--check)").addClass("kt-datatable__cell--sort").off("click").on("click", e.sortClick),
                            e.setIcon())
                        },
                        setIcon: function() {
                        ...
                        sortClick: function(n) {
                            ...
                            if ((void 0 === d.sortable || !1 !== d.sortable) && (t(o.tableHead).find("th").removeClass("kt-datatable__cell--sorted"),
                ...
                resetScroll: function() {
                    void 0 === i.detail && 1 === l.getDepth() && (t(o.table).find(".kt-datatable__row").css("left", 0),
                ...
                rowEvenOdd: function() {
                    t(o.tableBody).find(".kt-datatable__row").removeClass("kt-datatable__row--even"),
                    t(o.wrap).hasClass("kt-datatable--subtable") ? t(o.tableBody).find(".kt-datatable__row:not(.kt-datatable__row-detail):even").addClass("kt-datatable__row--even") : t(o.tableBody).find(".kt-datatable__row:nth-child(even)").addClass("kt-datatable__row--even")
                },
                timer: 0,
                redraw: function() {
                ...
                getRecord: function(e) {
                    ...
                    t(o.tableBody).find(".kt-datatable__cell:first-child").each(function(a, n) {
                        if (e == t(n).text()) {
                ...
                setActive: function(e) {
                    "string" == typeof e && (e = t(o.tableBody).find('.kt-checkbox--single > [type="checkbox"][value="' + e + '"]')),
                    t(e).prop("checked", !0);
                    var a = [];
                ...
                setSelectedRecords: function() {
                    return o.API.record = t(o.tableBody).find(".kt-datatable__row--active"),
                    o
                },
                ...
                rows: function(e) {
                    return l.isLocked() ? l.nodeTr = l.recentNode = t(o.tableBody).find(e).filter(".kt-datatable__lock--scroll > .kt-datatable__row") : l.nodeTr = l.recentNode = t(o.tableBody).find(e).filter(".kt-datatable__row"),
                    o
                },
                column: function(e) {
                    return l.nodeCols = l.recentNode = t(o.tableBody).find(".kt-datatable__cell:nth-child(" + (e + 1) + ")"),
                    o
                },
                columns: function(e) {
                    var a = o.table;
                    ...
                    return n.length > 0 ? l.nodeCols = l.recentNode = n : l.nodeCols = l.recentNode = t(a).find(e).filter(".kt-datatable__cell"),
                    o
                },
                cell: function(e) {
                    return l.cells(e),
            ...
            void 0 !== i)
                if ("string" == typeof i) {
                    ...
                    o.data(e) || t(this).hasClass("kt-datatable--loaded") || (o.dataSet = null,
                    o.textAlign = {
...
function(t) {
    ...
    t.fn.KTDatatable.checkbox = function(e, a) {
        var n = {
            ...
            initSelect: function() {
                n.selectedAllRows && a.vars.requestIds ? (e.hasClass("kt-datatable--error") || t(e.tableHead).find('.kt-checkbox--all > [type="checkbox"]').prop("checked", !0),
                e.setActiveAll(!0),
...
var KTAvatar = function(t, e) {
        ...
        var i = {}
          , o = {
            construct: function(t) {
                return KTUtil.data(n).has("avatar") ? a = KTUtil.data(n).get("avatar") : (o.init(t),
                o.build(),
            ...
            eventTrigger: function(t) {
                for (var e = 0; e < a.events.length; e++) {
                    var n = a.events[e];
                    n.name == t && (1 == n.one ? 0 == n.fired && (a.events[e].fired = !0,
                    n.handler.call(this, a)) : n.handler.call(this, a))
                }
            },
  ...
  , KTDialog = function(t) {
    var e, a = this, n = KTUtil.get("body"), i = {
          ...
          , l = {
            ...
            build: function() {
                ...
                !1 === a.options.minimize.mobile && !1 === a.options.minimize.desktop || window.addEventListener("scroll", function() {
                    var n, o, r, s = 0;
                    KTUtil.isInResponsiveRange("desktop") ? (s = a.options.offset.desktop,
                    n = a.options.minimize.desktop.on,
                    o = a.options.minimize.desktop.off) : KTUtil.isInResponsiveRange("tablet-and-mobile") && (s = a.options.offset.mobile,
                    n = a.options.minimize.mobile.on,
                    o = a.options.minimize.mobile.off),
                    r = window.pageYOffset,
                    KTUtil.isInResponsiveRange("tablet-and-mobile") && a.options.classic && a.options.classic.mobile || KTUtil.isInResponsiveRange("desktop") && a.options.classic && a.options.classic.desktop ? r > s ? (KTUtil.addClass(i, n),
                    KTUtil.removeClass(i, o),
                    e && (l.eventTrigger("minimizeOn", a),
                    e = !1)) : (KTUtil.addClass(i, o),
                    KTUtil.removeClass(i, n),
                    0 == e && (l.eventTrigger("minimizeOff", a),
                    e = !0)) : (r > s && t < r ? (KTUtil.addClass(i, n),
                    KTUtil.removeClass(i, o),
                    e && (l.eventTrigger("minimizeOn", a),
                    e = !1)) : (KTUtil.addClass(i, o),
                    KTUtil.removeClass(i, n),
            ...
            eventTrigger: function(t, e) {
                for (var n = 0; n < a.events.length; n++) {
                    var i = a.events[n];
                    i.name == t && (1 == i.one ? 0 == i.fired && (a.events[n].fired = !0,
                    i.handler.call(this, a, e)) : i.handler.call(this, a, e))
                }
            },
            addEvent: function(t, e, n) {
                a.events.push({
    ...
    if (i) {
        var l = {
          ...
          , r = {
            ...
            build: function() {
                a.eventHandlers.event_1 = KTUtil.on(i, ".kt-menu__toggle", "click", r.handleSubmenuAccordion),
                ("dropdown" === r.getSubmenuMode() || r.isConditionalSubmenuDropdown()) && (a.eventHandlers.event_2 = KTUtil.on(i, '[data-ktmenu-submenu-toggle="hover"]', "mouseover", r.handleSubmenuDrodownHoverEnter),
                a.eventHandlers.event_3 = KTUtil.on(i, '[data-ktmenu-submenu-toggle="hover"]', "mouseout", r.handleSubmenuDrodownHoverExit),
                a.eventHandlers.event_4 = KTUtil.on(i, '[data-ktmenu-submenu-toggle="click"] > .kt-menu__toggle, [data-ktmenu-submenu-toggle="click"] > .kt-menu__link .kt-menu__toggle', "click", r.handleSubmenuDropdownClick),
                a.eventHandlers.event_5 = KTUtil.on(i, '[data-ktmenu-submenu-toggle="tab"] > .kt-menu__toggle, [data-ktmenu-submenu-toggle="tab"] > .kt-menu__link .kt-menu__toggle', "click", r.handleSubmenuDropdownTabClick)),
                a.eventHandlers.event_6 = KTUtil.on(i, ".kt-menu__item > .kt-menu__link:not(.kt-menu__toggle):not(.kt-menu__link--toggle-skip)", "click", r.handleLinkClick),
            ...
            scrollInit: function() {
                a.options.scroll && a.options.scroll.height ? (KTUtil.scrollDestroy(i),
                KTUtil.scrollInit(i, {
                    mobileNativeScroll: !0,
                    windowScroll: !1,
            ...
            handleSubmenuDropdownClick: function(t) {
                if ("accordion" !== r.getSubmenuMode(this)) {
                    ...
                    "accordion" != e.getAttribute("data-ktmenu-submenu-mode") && (!1 === KTUtil.hasClass(e, "kt-menu__item--hover") ? (KTUtil.addClass(e, "kt-menu__item--open-dropdown"),
                    r.showSubmenuDropdown(e)) : (KTUtil.removeClass(e, "kt-menu__item--open-dropdown"),
            ...
            handleSubmenuDropdownTabClick: function(t) {
                if ("accordion" !== r.getSubmenuMode(this)) {
                    var e = this.closest(".kt-menu__item");
                    "accordion" != e.getAttribute("data-ktmenu-submenu-mode") && (0 == KTUtil.hasClass(e, "kt-menu__item--hover") && (KTUtil.addClass(e, "kt-menu__item--open-dropdown"),
            ...
            handleSubmenuAccordion: function(t, e) {
                var n, i = e || this;
                if ("dropdown" === r.getSubmenuMode(e) && (n = i.closest(".kt-menu__item")) && "accordion" != n.getAttribute("data-ktmenu-submenu-mode"))
                    t.preventDefault();
                else {
            ...
            hideSubmenuDropdown: function(t, e) {
                e && (KTUtil.removeClass(t, "kt-menu__item--hover"),
                KTUtil.removeClass(t, "kt-menu__item--active-tab")),
                t.removeAttribute("data-hover"),
                t.getAttribute("data-ktmenu-dropdown-toggle-class") && KTUtil.removeClass(o, t.getAttribute("data-ktmenu-dropdown-toggle-class"));
            ...
            showSubmenuDropdown: function(t) {
                ...
                t.getAttribute("data-ktmenu-dropdown-toggle-class") && KTUtil.addClass(o, t.getAttribute("data-ktmenu-dropdown-toggle-class"))
            },
            ...
            togglerClass: function(t, e) {
                ...
                if (a.options.toggleBy && a.options.toggleBy[0] && a.options.toggleBy[0].target)
                    for (var o in a.options.toggleBy)
                        a.options.toggleBy[o].target === i && (n = a.options.toggleBy[o]);
                else
  ...
  , KTPortlet = function(t, e) {
    ...
    if (n) {
        var o = {
          ...
          , l = {
            construct: function(t) {
                return KTUtil.data(n).has("portlet") ? a = KTUtil.data(n).get("portlet") : (l.init(t),
                l.build(),
            ...
            onScrollSticky: function(t) {
                ...
                if (!isNaN(e)) {
                    ...
                    o >= e && !1 === KTUtil.hasClass(i, "kt-portlet--sticky") ? (l.eventTrigger("stickyOn"),
                    KTUtil.addClass(i, "kt-portlet--sticky"),
                    KTUtil.addClass(n, "kt-portlet--sticky"),
                    l.updateSticky()) : 1.5 * o <= e && KTUtil.hasClass(i, "kt-portlet--sticky") && (l.eventTrigger("stickyOff"),
            ...
            updateSticky: function() {
                var t, e, n;
                a.head && (KTUtil.hasClass(i, "kt-portlet--sticky") && (t = a.options.sticky.position.top instanceof Function ? parseInt(a.options.sticky.position.top.call(this, a)) : parseInt(a.options.sticky.position.top),
            ...
            resetSticky: function() {
                a.head && !1 === KTUtil.hasClass(i, "kt-portlet--sticky") && (KTUtil.css(a.head, "z-index", ""),
                KTUtil.css(a.head, "top", ""),
                KTUtil.css(a.head, "left", ""),
                KTUtil.css(a.head, "right", ""))
            },
            remove: function() {
                !1 !== l.eventTrigger("beforeRemove") && (KTUtil.hasClass(i, "kt-portlet--fullscreen") && KTUtil.hasClass(n, "kt-portlet--fullscreen") && l.fullscreen("off"),
                l.removeTooltips(),
                KTUtil.remove(n),
          ...
          , o = {
            ...
            goTo: function(t) {
                if (!(t === a.currentStep || t > a.totalSteps || t < 0)) {
                    var e;
                    if (e = (t = t ? parseInt(t) : o.getNextStep()) > a.currentStep ? o.eventTrigger("beforeNext") : o.eventTrigger("beforePrev"),
                    !0 !== a.stopped)
                        return !1 !== e && (o.eventTrigger("beforeChange"),
                        a.currentStep = t,
                        o.updateUI(),
                        o.eventTrigger("change")),
                        t > a.startStep ? o.eventTrigger("afterNext") : o.eventTrigger("afterPrev"),
                        a;
                    a.stopped = !1
                }
            },
            ...
            updateUI: function() {
                ...
                if (n && n.length > 0)
                    for (var i = 0, l = n.length; i < l; i++)
                        i == e ? KTUtil.attr(n[i], "data-ktwizard-state", "current") : i < e ? KTUtil.attr(n[i], "data-ktwizard-state", "done") : KTUtil.attr(n[i], "data-ktwizard-state", "pending");
                var r = KTUtil.findAll(a.element, '[data-ktwizard-type="step-info"]');
                if (r && r.length > 0)
                    for (i = 0,
                    l = r.length; i < l; i++)
                        i == e ? KTUtil.attr(r[i], "data-ktwizard-state", "current") : KTUtil.removeAttr(r[i], "data-ktwizard-state");
                var s = KTUtil.findAll(a.element, '[data-ktwizard-type="step-content"]');
                if (s && s.length > 0)
                    for (i = 0,
                    l = s.length; i < l; i++)
                        i == e ? KTUtil.attr(s[i], "data-ktwizard-state", "current") : KTUtil.removeAttr(s[i], "data-ktwizard-state")
            },
            ...
            KTUtil.scrollInit(e, {
                ...
                height: function() {
                    ...
                    if (KTUtil.isInResponsiveRange("tablet-and-mobile"))
                        return KTUtil.hasAttr(e, "data-mobile-height") ? parseInt(KTUtil.attr(e, "data-mobile-height")) : 300;
                    if (KTUtil.isInResponsiveRange("desktop") && KTUtil.hasAttr(e, "data-height"))
                    ...
                    return a = KTUtil.isInResponsiveRange("desktop") ? KTLayout.getContentHeight() : KTUtil.getViewPort().height,
                    n && (a = (a = a - parseInt(KTUtil.css(n, "margin-top")) - parseInt(KTUtil.css(n, "margin-bottom"))) - parseInt(KTUtil.css(n, "padding-top")) - parseInt(KTUtil.css(n, "padding-bottom"))),
                    i && (a = (a -= parseInt(KTUtil.css(i, "height"))) - parseInt(KTUtil.css(i, "margin-top")) - parseInt(KTUtil.css(i, "margin-bottom"))),
                    o && (a = (a = a - parseInt(KTUtil.css(o, "margin-top")) - parseInt(KTUtil.css(o, "margin-bottom"))) - parseInt(KTUtil.css(o, "padding-top")) - parseInt(KTUtil.css(o, "padding-bottom"))),
                    l && (a = (a -= parseInt(KTUtil.css(l, "height"))) - parseInt(KTUtil.css(l, "margin-top")) - parseInt(KTUtil.css(l, "margin-bottom"))),
                    a -= 5
                }
            });
            var a = function() {
            ...
            !function() {
                ...
                KTUtil.scrollInit(n, {
                    ...
                    height: function() {
                        ...
                        return a && (t -= parseInt(KTUtil.actualHeight(a)),
        ...
        init: function() {
            !function() {
                ...
                KTUtil.scrollInit(a, {
                    ...
                    height: function() {
                        ...
                        return e && (a -= parseInt(KTUtil.actualHeight(e)),
            ...
            function() {
                ...
                KTUtil.scrollInit(a, {
                    ...
                    height: function() {
                        var a = parseInt(KTUtil.getViewPort().height);
                        return t && (a -= parseInt(KTUtil.actualHeight(t)),
            ...
            function() {
                ...
                KTUtil.scrollInit(e, {
                    ...
                    height: function() {
                        ...
                        return t && (e -= parseInt(KTUtil.actualHeight(t)),
...
var KTQuickSearch = function() {
    var t, e, a, n, i, o, l, r, s = "", d = !1, c = !1, u = !1, p = "kt-spinner kt-spinner--input kt-spinner--sm kt-spinner--brand kt-spinner--right", f = "kt-quick-search--has-result", g = function() {
        u = !1,
        ...
        setTimeout(function() {
            $.ajax({
                ...
                error: function(e) {
                    ...
                    g(),
                    KTUtil.addClass(t, f),
                    KTUtil.setHTML(i, '<span class="kt-quick-search__message">Connection error. Pleae try again later.</div>'),
                    h(),
                    KTUtil.scrollUpdate(i)
                }
            })
...
var KTLayout = function() {
        ...
        return new KTPortlet("kt_page_portlet",{
            sticky: {
                ...
                position: {
                    top: function() {
                        var e = 0;
                        return KTUtil.isInResponsiveRange("desktop") ? (KTUtil.hasClass(t, "kt-header--fixed") && (e += parseInt(KTUtil.css(KTUtil.get("kt_header"), "height"))),
                        KTUtil.hasClass(t, "kt-subheader--fixed") && KTUtil.get("kt_subheader") && (e += parseInt(KTUtil.css(KTUtil.get("kt_subheader"), "height")))) : KTUtil.hasClass(t, "kt-header-mobile--fixed") && (e += parseInt(KTUtil.css(KTUtil.get("kt_header_mobile"), "height"))),
                        e
                    },
                    left: function(t) {
                        var e = t.getSelf();
    ...
    return {
        ...
        initHeader: function() {
            ...
            (t = KTUtil.attr(n, "data-ktheader-minimize-offset")) && (i.offset.desktop = t),
            (t = KTUtil.attr(n, "data-ktheader-minimize-mobile-offset")) && (i.offset.mobile = t),
        ...
        initAside: function() {
            ...
            d = KTUtil.hasClass(s, "kt-aside--offcanvas-default") ? "kt-aside--offcanvas-default" : "kt-aside",
            ...
            KTUtil.hasClass(t, "kt-aside--fixed") && "1" == KTUtil.attr(c, "data-ktmenu-scroll") && (KTUtil.addEvent(s, "mouseenter", function(e) {
                e.preventDefault(),
                !1 !== KTUtil.isInResponsiveRange("desktop") && (r && (clearTimeout(r),
                r = null),
                a = setTimeout(function() {
                    KTUtil.hasClass(t, "kt-aside--minimize") && KTUtil.isInResponsiveRange("desktop") && (KTUtil.removeClass(t, "kt-aside--minimize"),
            ...
            KTUtil.addEvent(s, "mouseleave", function(e) {
                e.preventDefault(),
                !1 !== KTUtil.isInResponsiveRange("desktop") && (a && (clearTimeout(a),
                a = null),
                r = setTimeout(function() {
                    KTUtil.hasClass(t, "kt-aside--minimize-hover") && KTUtil.isInResponsiveRange("desktop") && (KTUtil.removeClass(t, "kt-aside--minimize-hover"),
            ...
            function() {
                ...
                "1" === KTUtil.attr(e, "data-ktmenu-scroll") && (t = {
                    ...
                    height: function() {
                        var t;
                        return t = KTUtil.isInResponsiveRange("desktop") ? parseInt(KTUtil.getViewPort().height) - parseInt(KTUtil.actualHeight("kt_header_brand")) : parseInt(KTUtil.getViewPort().height),
                        t -= parseInt(KTUtil.css(e, "marginBottom")) + parseInt(KTUtil.css(e, "marginTop"))
                    }
                }),
        ...
        initPageStickyPortlet: function() {
            KTUtil.get("kt_page_portlet") && ((l = r()).initSticky(),
            KTUtil.addResizeHandler(function() {
                l.updateSticky()
            }),
            r())
        ...
        getContentHeight: function() {
            return t = KTUtil.getViewPort().height,
            KTUtil.getByID("kt_header") && (t -= KTUtil.actualHeight("kt_header")),
            KTUtil.getByID("kt_subheader") && (t -= KTUtil.actualHeight("kt_subheader")),
            KTUtil.getByID("kt_footer") && (t -= parseInt(KTUtil.css("kt_footer", "height"))),
            KTUtil.getByID("kt_content") && (t = t - parseInt(KTUtil.css("kt_content", "padding-top")) - parseInt(KTUtil.css("kt_content", "padding-bottom"))),
            t;
            var t
        }
    }
